...
const BLOG = {
  ...
  GREETING_WORDS:
    ...
    "Hi, I'm a Programmer, Hi, I'm a Christain, Hi, I'm a Son, Welcome to My Blog🎉",
  ...
  BIO: process.env.NEXT_PUBLIC_BIO || 'Programmer | Christain | Son', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.rahc.top', // 网站地址
  ...
  TITLE: process.env.NEXT_PUBLIC_TITLE || "Mr.Charley's Blog", // 站点标题 ，被notion中的页面标题覆盖；此处请勿留空白，否则服务器无法编译
  HOME_BANNER_IMAGE:
    process.env.NEXT_PUBLIC_HOME_BANNER_IMAGE || '/bg_image.jpg', // 首页背景大图, 会被notion中的封面图覆盖，若无封面图则会使用代码中的 /public/bg_image.jpg 文件
  DESCRIPTION:
    process.env.NEXT_PUBLIC_DESCRIPTION ||
    "This is Charley's Blog, Powered by NotionNext", // 站点描述，被notion中的页面描述覆盖
